...
- `docs/SETUP.md` — 0부터 운영까지 단계별 가이드.
...
4. GitHub Repo Secrets 설정 후 push → 자동 cron 시작.
...
3. **5% 안전 마진**. 환율 변동 + 카드 수수료를 커버. 잉여금은 다음 달 이월.
4. **무료 운영**. Workers 무료 티어 + GitHub Actions 무료 티어로 평생 무료.
